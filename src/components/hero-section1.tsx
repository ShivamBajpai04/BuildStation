      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            >
              Experience the future of job matching with AI-powered recommendations and blockchain-verified credentials. Connect with opportunities that align with your skills and aspirations.
            </motion.p>
            <motion.div 
